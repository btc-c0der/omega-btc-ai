            ...
            try:
                ...
                if self.symbol:
                    ...
                    try:
                        ...
                        print(f"{Fore.RED}Error getting all positions: {str(general_err)}{Style.RESET_ALL}")
                        continue
                ...
                print(f"{Fore.RED}Error getting positions for {profile_name}: {str(e)}{Style.RESET_ALL}")
