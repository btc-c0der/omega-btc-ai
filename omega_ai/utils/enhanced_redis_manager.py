...
Resilient Redis connection manager with automatic failover capabilities
between remote and local Redis instances. Provides seamless operation
even during temporary remote Redis outages.

Features:
- Automatic failover between remote and local Redis
- Data synchronization when remote Redis reconnects
- Configurable retry intervals and key prioritization
